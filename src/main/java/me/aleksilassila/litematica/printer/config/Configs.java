...
public class Configs {
        ...
        public static final ConfigBoolean INTERACT_BLOCKS = new ConfigBoolean("interactBlocks", true)
                        .apply(GENERIC_KEY);
        public static final ConfigBoolean AIR_PLACE_BLOCKS = new ConfigBoolean("airPlace", true,
                        "Allows the printer to build blocks without support", "Air Place Blocks").apply(GENERIC_KEY);
